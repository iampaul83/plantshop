...
<div class="col-md-4 mb-4" v-for="item in products" :key="item.id">
  <div class="card border-0" >
    <a href="#" style="height: 150px; background-size: cover; background-position: center" :style="{backgroundImage : `url(${item.imageUrl})`}">
    </a>
    <div class="card-body">
      ...
      <div class="price-box d-flex  flex-column">
        <del class="orginPrice">{{item.originPrice}} 元</del>
        <div class="h5 text-success">{{item.price}} 元</div>
      </div>
